...
class RoomHostResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'name' => $this->name[$locale] ?? ($this->name['fr'] ?? $this->name),
            'description' => $this->description[$locale] ?? ($this->description['fr'] ?? $this->description),
